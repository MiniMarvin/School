...
RESET1: ; Reset da contagem das dezenas de forma progressiva
	mov R0, #30h ; reseta a contagem para a posicao de memoria 2fh, correspondente ao numero 0.
	inc R1
	cjne R1, #3Ah, FFT4 ; Compara se a contagem nao estourou incrementando.
	ljmp RESET1_1
	FFT4:
...
BEGIN:
	...
	POPIT:
	;ljmp DEC_IT1 ;soma 1 ao registrador R1
	NETIT:
...
RESET1_1: ; Reset da contagem das unidades de forma progressiva
	mov R1, #30h; Inicia a contagem na posicao de memoria 2fh, correspondente ao numero 0.
	ljmp BEGIN
